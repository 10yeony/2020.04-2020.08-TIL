	...
	<div id="login">
		<c:choose>
			<c:when test="${member != null}">
				<form method="post" action="member.do" autocomplete="off">
					<button type="submit"><img class="menu" src="image/menu/logout.png">로그아웃</button>
          ...
          <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
            ...
            <div id="updateArea" class="w3-section" style="padding:40px;">
              ...
              <div>
                ...
                <button class="w3-section w3-padding" id=nicknameCheck type="button">중복 확인</button>
              </div>
              <label>
                <b>비밀번호</b>
              </label>
