...
public class OperatorAppTest1 { // 실행 테스트 이름은 Test로 끝나거나 AppTest로 끝남
	...
	public static void main(String[] args) {
		...
		System.out.println(o1.test1() || o1.test2()); // ||는 or 연산자. true
		// or 연산자 쓸 때 | 써도 되지만 ||가 더 성능과 정확도 면에서 더 효율적. 
		// ||은 앞 연산이 true면 true로 간주하고 뒷 연산 건너뜀
		System.out.println(o1.test1() && o1.test2()); // false 
		// ||는 앞에꺼가 true일 때 돌아가고, &&는 앞에꺼가 false일 때 돌아감.
 	}
