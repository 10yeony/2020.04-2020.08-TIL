 ...
 * Generated at: 2020-07-03 05:49:04 UTC
...
public final class team_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("var mode = \"pitcher\";\r\n");
      out.write("\r\n");
      out.write("function selectTeam(setTeam){\r\n");
      out.write("\tteam = setTeam;\r\n");
      out.write("\tsearch(mode,team);\r\n");
      out.write("}\r\n");
      out.write("function selectMode(setMode){\r\n");
      out.write("\tmode = setMode;\r\n");
      out.write("\tsearch(mode,team);\r\n");
      out.write("}\r\n");
      out.write("function search(mode, team) {\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\ttype:'post',\r\n");
      out.write("\t\turl:'/'+mode+'.do',\r\n");
      out.write("\t\tdata:'teamCode='+team,\r\n");
      out.write("\t\tdataType:'json',\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t$('#list-table').empty();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(mode==\"pitcher\"){\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"<thead id='list-head'>\");\r\n");
      out.write("\t\t\t\t$('#list-head').append(\"<tr><th>소속</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>이름</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>경기</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>이닝</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>방어율</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>승리</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>패배</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>세이브</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>홀드</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>실점</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>안타</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>삼진</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>볼넷</th></tr>\");\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"</thead>\");\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"<tbody id='list-body'>\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$.each(data.list, function(index, list){\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tif(list.teamCode==\"OB\") list.teamCode = \"두산\";\r\n");
      out.write("\t\t\t\t\telse if(list.teamCode==\"SS\") list.teamCode = \"삼성\";\r\n");
      out.write("\t\t\t\t\telse if(list.teamCode==\"HH\") list.teamCode = \"한화\";\r\n");
      out.write("\t\t\t\t\telse if(list.teamCode==\"HT\") list.teamCode = \"기아\";\r\n");
      out.write("\t\t\t\t\telse if(list.teamCode==\"LT\") list.teamCode = \"롯데\";\r\n");
      out.write("\t\t\t\t\telse if(list.teamCode==\"WO\") list.teamCode = \"키움\";\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$('#list-body').append(\"<tr id=\"+list.playerId+\">\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.teamCode+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.name+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.games+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.inning+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td style='font-weight:bold;'>\"+list.era.toFixed(2)+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.win+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.lose+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.save+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.hold+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.runs+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.hits+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.so+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.bb+\"</td></tr>\");\r\n");
      out.write("\t\t\t\t});//each\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"</tbody>\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"<thead id='list-head'>\");\r\n");
      out.write("\t\t\t\t$('#list-head').append(\"<tr><th>소속</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>이름</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>경기</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>타율</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>타수</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>안타</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>홈런</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>타점</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>득점</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>삼진</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>볼넷</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>출루율</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>장타율</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>OPS</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>도루</th>\");\r\n");
      out.write("\t\t\t\t$('#list-head tr').append(\"<th>실책</th></tr>\");\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"</thead>\");\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"<tbody id='list-body'>\");\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$.each(data.list, function(index, list){\r\n");
      ...
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.name+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.games+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td style='font-weight:bold;'>\"+list.rate.toFixed(3)+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.ab+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.hits+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.hr+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.rbi+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.runs+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.so+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.bb+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.obp.toFixed(3)+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.slg.toFixed(3)+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.ops.toFixed(3)+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.steal+\"</td>\");\r\n");
      out.write("\t\t\t\t\t$('#'+list.playerId).append(\"<td>\"+list.error+\"</td></tr>\");\r\n");
      out.write("\t\t\t\t});//each\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t$('#list-table').append(\"</tbody>\");\r\n");
      out.write("\t\t\t};\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t$('#list-body tr').hover(function() {\r\n");
      out.write("\t\t\t\tvar playerId = $(this).attr(\"id\");\r\n");
      out.write("\t\t\t \t$.ajax({\r\n");
      out.write("\t\t\t\t\ttype:'post',\r\n");
      out.write("\t\t\t\t\turl:'/display.do',\r\n");
      out.write("\t\t\t\t\tdata:'playerId='+playerId,\r\n");
      out.write("\t\t\t\t\tdataType:'json',\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\t\t\t$.each(data.list, function(index, list){\r\n");
      out.write("\t\t\t\t\t\t$('#review').empty();\r\n");
      out.write("\t\t\t\t\t\t$('#review').append(\"<img alt='' src='image/player/\"+list.playerId+\".jpg' width='180px' height='226px' style='margin-top: 10px'><br/>\");\r\n");
      out.write("\t\t\t\t\t\t$('#review').append(\"<hr><div>\"+list.name+\" (\"+list.position+\")</div><br/>\");\r\n");
      out.write("\t\t\t\t\t\t$('#review').append(\"<div>NO. \"+list.number+\"</div><br/>\");\r\n");
      out.write("\t\t\t\t\t\t$('#review').append(\"<div>\"+list.birth+\"</div><br/>\");\r\n");
      out.write("\t\t\t\t\t\t$('#review').append(\"<div>\"+list.type+\"</div><br/>\");\r\n");
      out.write("\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t}//success\r\n");
      out.write("\t\t\t\t})//ajax  \r\n");
      out.write("\t\t\t})//hover\r\n");
      ...
      out.write("      </div>\r\n");
      out.write("      <hr>\r\n");
      out.write("      <div align=\"center\" style=\"font-size: 1.0em;\">\r\n");
      out.write("      \t<span id=\"search\"><a href=\"javascript:selectMode('pitcher')\">투수기록</a></span>\r\n");
      out.write("      \t<span> | </span>\r\n");
      out.write("      \t<span id=\"search\"><a href=\"javascript:selectMode('hitter')\">타자기록</a></span>\r\n");
      out.write("      </div>\r\n");
      out.write("​\r\n");
      out.write("      <!-- 카드 클래스안에 데이터만 입력 원하는 비율 선택-->\r\n");
      out.write("      <div class=\"w3-row\">\r\n");
      out.write("      \r\n");
      out.write("        <div id=\"detail\" class=\"w3-col w3-panel w3-padding-16\" style=\"width: 20%;\">\r\n");
      out.write("          <div class=\"w3-card\" align=\"center\" id=\"review\">\r\n");
      out.write("          \t<img alt=\"\" src=\"image/profile/default.png\" width=\"180px\" height=\"226px\" style=\"margin-top: 5px;\">\r\n");
      out.write("          \t<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>\r\n");
      out.write("\t\t  </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        \r\n");
      out.write("        \r\n");
      out.write("        <div id=\"list\" class=\"w3-col w3-panel w3-padding-16\">\r\n");
      out.write("          <div id=\"list-div\" class=\"w3-card\">\r\n");
      out.write("          \t<table id=\"list-table\" class=\"w3-table-all w3-hoverable\">\r\n");
      ...
      out.write("​\r\n");
      out.write("    </section>\r\n");
      out.write("  </div> <!-- </div>태그 지우면 nav깨짐 -->\r\n");
      out.write("​\r\n");
      out.write("  <script>\r\n");
      out.write("    // Open and close the sidebar on medium and small screens\r\n");
      out.write("    function navOpen() {\r\n");
